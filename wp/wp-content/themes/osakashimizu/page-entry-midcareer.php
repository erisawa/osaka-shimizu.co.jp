<?php
/**
 * Template Name: 中途採用エントリーフォームページ
 * Description: 中途採用エントリーフォームページ用テンプレート
 */
get_header();
?>
        ...
        <div id="contents" class="contents-entry">
            ...
            <div class="contents_inner_s">
                <?php
                // ページ判定
                $is_confirm = is_page( 'entry-midcareer-confirm' );
                $is_thanks  = is_page( 'entry-midcareer-thanks' );
                ?>
                ...
                <header>
                    <h1>
                        <span class="recruit-page-title-ja"><span>中途</span>採用<br>エントリーフォーム</span>
                        <span class="recruit-page-title-en en">MID-CAREER RECRUITMENT INFORMATIONS</span>
                    </h1>
                </header>
                <?php endif; ?>

                <?php if ( ! $is_confirm && ! $is_thanks ) : ?>
                    <!-- ★入力ページだけで表示するテキスト -->
                    <p class="intro-text">
                        このたびは株式会社大阪シミズの中途採用情報に興味をお持ちいただき、誠にありがとうございます。<br>
                        下記「エントリーに関する条件」に従いエントリーを行ってください。<br>
                ...
                <section class="recruit-section-message c-box">
                    ...
                    <ul>
                        ...
                        <li>当フォームでお知らせいただける「職歴」は直近5職までとさせていただきます。後日、「職務経歴書」を別途ご提出いただきますので、5つ以上の職歴をお持ちの方もご安心ください。</li>
                ...
                <div class="c-form">
                    ...
                    echo do_shortcode( '[contact-form-7 id="eb4bdc7" title="中途採用エントリーフォーム"]' );
                    ?>
                    ...
                    echo do_shortcode( '[contact-form-7 id="db641f1" title="中途採用エントリーフォーム（入力）"]' );
                    ?>
