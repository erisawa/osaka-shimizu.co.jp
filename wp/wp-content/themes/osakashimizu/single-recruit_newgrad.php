<?php
/**
 * Template Name: 新卒採用募集要項詳細ページ
 * Description: 新卒採用募集要項詳細ページ用テンプレート
 */
get_header();
?>
        ...
        <section class="recruit-detail">
          ...
          <header class="recruit-detail__head">
            ...
            <div class="recruit-detail__head-main">
              <div class="recruit-detail__head-text">
                <span class="recruit-detail__label">新卒採用</span>
          ...
          <section class="recruit-detail__section">
            ...
            <div class="recruit-detail__entry">
              ...
              $entry_page = get_page_by_path( 'recruit/entry-newsnewgrad' );
              if ( $entry_page ) :
                $entry_url = get_permalink( $entry_page );
              else :
                // 念のためのフォールバック
                $entry_url = home_url( '/recruit/entry-newsnewgrad/' );
              endif;
              ?>
              <a href="<?php echo esc_url( $entry_url ); ?>" class="link_btn">
                <span class="link_btn_text">新卒採用エントリーフォーム</span>
