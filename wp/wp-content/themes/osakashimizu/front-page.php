            ...
            <section id="top_business">
                <div class="contents_inner_s">
                    <div class="top_business_lead">
                        ...
                        <p>大阪シミズはライブや展示会、スポーツイベント、その他あらゆる催事のプランニング、設計、制作、運営、警備など開催・運営に必要となるすべてのモノ・コトをご提供しています。</p>
                    </div>
                </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="swiper-catch">
                                <div class="swiper-catch-inner">
                                    ...
                                    <div class="top_business_slide_txt">
                                        <h3>資材管理</h3>
                                        <p>会場設営で使用するすべての資機材調達、管理、安全性能維持のためのメンテナンス、そして現場での資材搬入出を担当。安全催事の根幹を担います。</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="swiper-catch">
                                <div class="swiper-catch-inner">
                                    ...
                                    <div class="top_business_slide_txt">
                                        <h3>営業</h3>
                                        <p>主催側との窓口役。コンセプトやマインドを共有し、催事全体のディレクションと予算管理を担当。クライアントの声をしっかりと現場にお伝えします。</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            ...
                            <div class="swiper-catch">
                                <div class="swiper-catch-inner">
                                    ...
                                    <div class="top_business_slide_txt">
                                        <h3>運営</h3>
                                        <p>アルバイトや警備等の手配を担当。事前教育や当日の運営、スタッフ指揮も行い、催事のスムーズかつ安全な運営を牽引します。</p>
                                    </div>
                                </div>
                            </div>
                        </div>
